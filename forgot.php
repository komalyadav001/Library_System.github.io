...
<form  name="signup" action="" method="post">
        <b><h3 style="padding-left:30px;font-size:24px;font-weight:700;">Are You a Student or Admin?</h3></b><br>
		...
		if(isset($_POST['submit1'])){
          ...
          <script type="text/javascript">
            window.location="Admin_/update_password.php"
          </script>
        <?php
			}
		else{
			 ?>
          <script type="text/javascript">
            window.location="Student_/update_password.php"
          </script>
