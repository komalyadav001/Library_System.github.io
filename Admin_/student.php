...
<head>
  ...
  background-image:url("https://englishlive.ef.com/blog/wp-content/uploads/sites/2/2015/06/girl_reading.jpg");
  background-size:100%;
}
.glowing-text {
  font-size: 50px;
...
<div id="main">
  ...
  <span style="font-size:30px;cursor:pointer;color:yellow; text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;color:white;" onclick="openNav()">&#9776; open</span>
...
<div class="container">
	...
	<h2 style="center;color: white;
  text-shadow: 43px 7px 42px #ff9800, 0 0 25px #e3e217, 0 0 5px #0cf149;">List Of Students</h2>
	<?php
		...
		echo "<table class='table table-bordered table-hover' >";
			echo "<tr style='background-color: #520808; color:white;'>";
				//Table header
				echo "<th>"; echo "First Name";	echo "</th>";
				echo "<th>"; echo "Last Name";  echo "</th>";
				echo "<th>"; echo "Username";  echo "</th>";
